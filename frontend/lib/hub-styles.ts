...
export const hubBtnPrimary =
  'hub-btn-primary inline-flex w-full items-center justify-center rounded-xl px-4 py-2.5 text-sm font-semibold shadow-sm transition';

export const hubBtnSecondary =
  'inline-flex items-center justify-center rounded-xl border border-[var(--color-hub-border)] bg-[var(--color-hub-surface)] px-4 py-2.5 text-sm font-medium text-[var(--color-hub-text-secondary)] transition hover:border-[var(--color-brand)]/30 hover:bg-[var(--color-brand-soft)] disabled:opacity-60';
...
export const hubPageTitle = 'hub-display text-3xl text-[var(--color-hub-text)]';
